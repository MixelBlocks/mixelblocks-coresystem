...
/**
 * mixelblocks-coresystem; de.mixelblocks.coresystem.economy:EconomySystemProviderImpl
 *
 * @author LuciferMorningstarDev - https://github.com/LuciferMorningstarDev
 * @since 30.01.2022
 */
public class EconomySystemProviderImpl implements EconomySystemProvider {

    private MongoDatabaseHandler database;

    public EconomySystemProviderImpl(MongoDatabaseHandler database) {
        this.database = database;
    }

    @Override
    public EconomyPlayerData playerData(UUID uuid) {
        return new EconomyPlayerDataImpl(uuid, this);
    }
