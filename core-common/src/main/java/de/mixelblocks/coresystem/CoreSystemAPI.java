...
/**
 * mixelblocks-coresystem; de.mixelblocks.coresystem:CoreSystemAPI
 *
 * @author LuciferMorningstarDev - https://github.com/LuciferMorningstarDev
 * @since 30.01.2022
 */
public class CoreSystemAPI {
     ...
     * @return provider
     */
    public static CoreSystemProvider get() {
        return provider;
    }

    /**
     * Package private method to set the provider
     * @param provider
     */
    static void setProvider(CoreSystemProvider provider) {
        CoreSystemAPI.provider = provider;
    }
