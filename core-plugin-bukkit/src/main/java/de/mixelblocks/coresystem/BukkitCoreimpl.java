...
/**
 * mixelblocks-coresystem; de.mixelblocks.coresystem:BukkitCoreimpl
 *
 * @author LuciferMorningstarDev - https://github.com/LuciferMorningstarDev
 * @since 30.01.2022
 */
public class BukkitCoreimpl implements BukkitCore {

    private final CoreSystemProvider core;
    private final CoreSystemBukkitPlugin plugin;

    public BukkitCoreimpl(CoreSystemProvider core, CoreSystemBukkitPlugin plugin) {
        this.core = core;
        this.plugin = plugin;
    }

    @Override
    public CoreSystemProvider coreSystem() {
        return core;
    }
