 ...
 *
 */
package de.mixelblocks.coresystem.mongodb;
...
/**
 * mixelblocks-coresystem; de.mixelblocks.coresystem.mongodb:MongoDatabaseHandler
 *
...
public class MongoDatabaseHandler {
     ...
     */
    public static MongoDatabaseHandler fromMongoDatabaseConfig(MongoDatabaseConfig config) {
        return new MongoDatabaseHandler(config.getConnectionString(), config.getUsedDatabase());
    }
